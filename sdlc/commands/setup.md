...
The current plugin version is **6.0.0**. Compare what you found in the config:

**If the config shows `sdlc_version: "6.0.0"` (versions match):**
```
SDLC is already configured and up to date (v6.0.0).
...
6. Update `sdlc_version` in `.claude/sdlc.yaml` to **6.0.0**
